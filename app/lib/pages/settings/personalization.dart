...
import 'package:vulpine/helpers/theme_mode.dart';
...
class PersonalizationSettingsPage extends StatelessWidget {
  ...
  String _getLocaleName(BuildContext context, String locale) =>
      locale.isNotEmpty
          ? LocaleNames.of(context)?.nameOf(locale.replaceAll('-', '_')) ??
              locale
                      ...
                      children: [
                        ...
                        if (!kIsWeb &&
                            (Platform.isWindows ||
                                Platform.isLinux ||
                                Platform.isMacOS))
                          BlocBuilder<SettingsCubit, VulpineSettings>(
                            buildWhen:
                                (previous, current) =>
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                            _getDensityName(context, state.density),
                          ),

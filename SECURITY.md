...
| Version | Supported |                                                                                                                  |
| ------- | --------- | ---------------------------------------------------------------------------------------------------------------- |
| 0.1.0   | :x:       | [Docs](https://vulpine.world/docs/v1/intro) [Release](https://github.com/LinwoodDev/Vulpine/releases/tag/v0.1.1) |
...
Please use [the bug tracker](https://github.com/LinwoodDev/Vulpine/issues) for reporting bugs. Please make sure you are on the latest stable or nightly release.

Use [security@linwood.dev](mailto:security@linwood.dev) or [the github security advisory](https://github.com/LinwoodDev/Vulpine/security/advisories) if you want to report a security vulnerability.
...
Read more about nightly [here](https://vulpine.world/community/nightly).
